    ...
    loadData() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (savedData) {
                ...
                try {
                    const response = yield fetch('./data/mock-data.json');
                    if (!response.ok)
...
class Router {
        ...
        const txRows = data.transactions.slice(0, 5).map(tx => `
            <div class="flex items-center justify-between p-4 hover:bg-slate-800/40 rounded-3xl transition-all cursor-pointer group border border-transparent hover:border-slate-700/50">
                ...
                <div class="font-extrabold text-lg ${tx.amount < 0 ? 'text-white' : 'text-green-400'}">
                    ${tx.amount < 0 ? '' : '+'}${tx.amount.toFixed(2)} ${mainAcc === null || mainAcc === void 0 ? void 0 : mainAcc.currency}
                </div>
            </div>
        `).join('');
        this.render(`
            ...
            <div class="grid grid-cols-1 xl:grid-cols-3 gap-8">
                ...
                <div class="xl:col-span-2 space-y-8">
                    <!-- MAIN CARD -->
                    <div class="card-gradient ${mainAcc === null || mainAcc === void 0 ? void 0 : mainAcc.color} p-10 rounded-[3.5rem] text-white shadow-2xl relative overflow-hidden group">
                        ...
                        <div class="relative z-10">
                            <div class="flex justify-between items-start mb-4">
                                <span class="text-sm font-bold opacity-70 uppercase tracking-widest">${mainAcc === null || mainAcc === void 0 ? void 0 : mainAcc.type}</span>
                                <div class="w-10 h-6 bg-yellow-500/20 rounded-md border border-yellow-500/30"></div>
                            </div>
                            <div class="text-6xl font-black mb-10 tracking-tighter">${mainAcc === null || mainAcc === void 0 ? void 0 : mainAcc.balance.toLocaleString()} ${mainAcc === null || mainAcc === void 0 ? void 0 : mainAcc.currency}</div>
                            <div class="flex justify-between items-end">
                                <div class="font-mono text-xl opacity-80 tracking-widest">${mainAcc === null || mainAcc === void 0 ? void 0 : mainAcc.number}</div>
    ...
    renderTransfers() {
                    ...
                    <div class="space-y-8">
                        <div>
                            ...
                            <div class="flex items-center gap-4 bg-slate-900/50 border border-slate-700 rounded-3xl p-5">
                                 <div class="w-12 h-12 card-gradient ${mainAcc === null || mainAcc === void 0 ? void 0 : mainAcc.color} rounded-2xl"></div>
                                 <div class="flex-grow">
                                    <div class="font-black text-white">${mainAcc === null || mainAcc === void 0 ? void 0 : mainAcc.type}</div>
                                    <div class="text-xs font-bold text-slate-500">${mainAcc === null || mainAcc === void 0 ? void 0 : mainAcc.number}</div>
                                 </div>
                                 <div class="text-right">
                                    <div class="font-black text-white">${mainAcc === null || mainAcc === void 0 ? void 0 : mainAcc.balance.toLocaleString()} ${mainAcc === null || mainAcc === void 0 ? void 0 : mainAcc.currency}</div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div>
                                <label class="text-xs font-black text-slate-500 uppercase ml-4 mb-3 block tracking-widest">Сума (${mainAcc === null || mainAcc === void 0 ? void 0 : mainAcc.currency})</label>
        ...
        `);
        (_a = document.getElementById('send-btn')) === null || _a === void 0 ? void 0 : _a.addEventListener('click', () => {
            var _a;
            ...
            if (to && amount > 0) {
                ...
                (_a = document.getElementById('tx-done')) === null || _a === void 0 ? void 0 : _a.classList.remove('hidden');
    ...
    renderCategoryItems(shortname) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const response = yield fetch(`./data/${shortname}.json`);
                if (!response.ok)
